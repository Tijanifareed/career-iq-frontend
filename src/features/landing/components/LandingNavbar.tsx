...
export default function LandingNavbar() {
  ...
  return (
    <nav className="w-full bg-white border-b shadow-sm px-4 sm:px-6 py-2 sm:py-3 flex justify-between items-center sticky top-0 z-50">
      {/* Left: Logo + Text */}
      <div
        className="flex items-center gap-2 cursor-pointer"
        onClick={() => navigate("/")}
      >
        ...
        />
        <span className="text-lg sm:text-xl font-bold italic text-customBlue font-inter">
          HireJourney
        </span>
      </div>
