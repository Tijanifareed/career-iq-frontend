...
//   // Placeholder for Google Picker integration (requires client ID & API keys)
//   function openGoogleDrivePicker() {
//     // TODO: Replace this stub with real Google Picker integration.
//     // Steps:
//     // 1. Load Google APIs and Picker JS
//     // 2. Authorize user and open the picker
//     // 3. On file select, fetch the file blob/content, convert to File, then call setSelectedFile(file)
//     //
//     // For now, we trigger the local file input as fallback:
//     fileInputRef.current?.click();
//     // When implementing real Picker, ensure you convert the selected Drive file to a File/Blob
//     // and call setSelectedFile(blobAsFile).
//   }
...
//     if (!selectedFile) {
//       setError("Please upload a resume (PDF/DOCX) before analyzing.");
//       return;
//     }
...
//       const res = await fetch("http://127.0.0.1:8000/ai/resume/analyze", {
//         method: "POST",
//         // NOTE: when using FormData, don't set Content-Type manually; browser sets the boundary.
//         body: formData,
//       });
...
//         throw new Error(
//           `Analyze request failed with ${res.status}. ${text ? `(${text})` : ""}`
//         );
//       }

//       const data: AnalyzeResponse = await res.json();
//       setResult(data);
//       if (data.extracted_text_preview) setShowExtractPreview(true);
//     } catch (err: any) {
...
//             {/* <h2 className="text-lg font-semibold">AI Resume Feedback</h2> */}
//           </div>
...
//               {/* Left column (inputs) - spans 2/3 */}
//               <div className="lg:col-span-2 space-y-6">
//                 {/* Upload box */}
//                 <div className="bg-white rounded-lg shadow p-6">
//                   <div className="flex items-center justify-between mb-4">
//                     <h3 className="text-lg font-medium">Upload Resume</h3>
//                     <div className="text-sm text-gray-500">Accepted: PDF, DOCX</div>
//                   </div>
...
//                           <div className="mt-4">
//                             <button
//                               onClick={() => setShowExtractPreview((s) => !s)}
//                               className="text-sm text-blue-600 underline"
//                             >
//                               {showExtractPreview ? "Hide" : "Show"} extracted text preview
//                             </button>
//                             {showExtractPreview && (
...
//                 {/* Optional: suggestions / results summary placed below inputs on left on small screens */}
//                 {result && (
//                   <div className="bg-white rounded-lg shadow p-6">
...
//                       <button
//                         onClick={() => {
//                           // focus on right column (no-op here) or toggle UI
...
//                     </div>
//                   ) : (
//                     <div className="text-sm text-gray-500">No missing keywords found.</div>
//                   )}
//                 </div>
