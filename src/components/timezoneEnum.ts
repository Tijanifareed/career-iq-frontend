// timezoneEnum.ts
export const TimezoneEnum: Record<string, string> = {
...
export function getTimezoneAbbr(timezone: string): string | null {
  for (const [abbr, value] of Object.entries(TimezoneEnum)) {
    if (value === timezone) {
      return abbr;
    }
  }
