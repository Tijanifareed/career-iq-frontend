...
interface PasswordInputFieldProps {
  ...
  value: string;
  onChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
  showForgotPassword?: boolean; // ✅ boolean flag
  forgotPasswordUrl?: string;   // ✅ optional url (only if showForgotPassword is true)
  placeholder?: string;
}
...
const PasswordInputField: React.FC<PasswordInputFieldProps> = ({
  ...
  value,
  onChange,
  showForgotPassword = false, // default hidden
